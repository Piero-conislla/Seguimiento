...
- **Base de datos y autenticación: Supabase** (proyecto propio, separado del que use el tablero Kanban). Tablas: `profiles`, `projects`, `risks`, `milestones`, `audit_log`, `statuses`, `stages`.
